...
- fix "onDestroy" event for iOS [#4](https://github.com/dart-flitter/earyzhe_webview_plugin/issues/4)
- fix fullscreen mode for iOS [#5](https://github.com/dart-flitter/earyzhe_webview_plugin/issues/5)
